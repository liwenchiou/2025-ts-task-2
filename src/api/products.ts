...
import type {CreateProductParams, CreateProductResponse,GetProductsResponse,EditProductResponse,DeleteProductResponse,UploadImageResponse,EditProductParams} from '@/types/product'
